...
```{r}
# flipping the unfair coin 100 times
sim_unfair_coin
table(sim_unfair_coin)

```

**22 times heads and 78 times tails came up**
...
**With the same probability of 0.45, i would expect it to be somewhat similar to the simulation above. Since they are independent and we are looking at the same amount of shots (133), i would expect the result to be similar.** 
...
**The distribution is similar (unimodal with right skewed) and the typical streak length is similar. However, the simulated shooter has better longest streak (8), compare to Kobe's longest streatk length. I dont see any evidence that the hot hand model fits Kobe's shooting pattern. The event of shots are independent from each other.**